...
class Addr:
    ...
    FLIPPERS = 0xDB3E
    MEDICINE = 0xDB3F
    TRADE_SEQUENCE_ITEM = 0xDB40
    SEASHELL_COUNT = 0xDB41
    GOLDEN_LEAVES = 0xDB42
    POWER_BRACELET_LEVEL = 0xDB43
    SHIELD_LEVEL = 0xDB44
    ARROW_COUNT = 0xDB45
    COLLECTED_SONGS = 0xDB49
    SELECTED_SONG = 0xDB4A
    POWDER_COUNT = 0xDB4C
    BOMB_COUNT = 0xDB4D
    SWORD_LEVEL = 0xDB4E
    BOWWOW = 0xDB56
    FULL_HEARTS = 0xDB5B
    HEART_PIECES = 0xDB5C
    RUPEE_COUNT_HIGH = 0xDB5D
    RUPEE_COUNT_LOW = 0xDB5E
    INSTRUMENT1 = 0xDB65
    INSTRUMENT2 = 0xDB66
    INSTRUMENT3 = 0xDB67
    INSTRUMENT4 = 0xDB68
    ...
    INSTRUMENT7 = 0xDB6B
    INSTRUMENT8 = 0xDB6C
    COLLECTED_TUNICS = 0xDB6D # and boots
    MAX_POWDER = 0xDB76
    MAX_BOMBS = 0xDB77
    MAX_ARROWS = 0xDB78
    TRADE_SEQUENCE_ITEM_2 = 0xDB7F
    HEALTH = 0xDB93
    SELECTED_TUNIC = 0xDC0F
    RECEIVED_INDEX = 0xDDFD
